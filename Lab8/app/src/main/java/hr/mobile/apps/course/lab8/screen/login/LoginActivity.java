...
import hr.mobile.apps.course.lab8.screen.home.HomeActivity;
import hr.mobile.apps.course.lab8.util.Validator;
import hr.mobile.apps.course.lab8.util.ViewUtil;
