...
import hr.mobile.apps.course.lab7.screen.home.HomeActivity;
import hr.mobile.apps.course.lab7.util.Validator;
import hr.mobile.apps.course.lab7.util.ViewUtil;
